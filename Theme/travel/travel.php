...
// ***	
// Update for GM 1.5
// See http://wordpress.org/support/topic/geo-mashup-error-travelphp-on-line-44
...
//	}
// ***
	if ( isset( $json_object['terms']['category'] ) ) {
		foreach($json_object['terms']['category'] as $key => $id){
			if(!in_array($id,$exclude)){
				unset($json_object['terms']['category'][$key]);
			}
		}
	}
	return $json_object;
